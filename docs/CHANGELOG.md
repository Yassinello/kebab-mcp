...
## [0.1.17](https://github.com/Yassinello/kebab-mcp/compare/v0.1.16...v0.1.17) (2026-09-25)


### Features

* **68-01:** register unipile in registry lazy loader (toolCount: 0) ([99d8c39](https://github.com/Yassinello/kebab-mcp/commit/99d8c39f63680d204ce6b56cd82f8fc4433b1e03))
* **68-01:** scaffold stub unipileConnector manifest (0 tools) ([ab0e3e2](https://github.com/Yassinello/kebab-mcp/commit/ab0e3e2f9c9b306bb0795406c8dfe522d7d382bd))
* **68-02:** lazy UnipileClient singleton + sanitize + reset (Task 1) ([ce030ad](https://github.com/Yassinello/kebab-mcp/commit/ce030adcb7f7b627ad8c71ca52f010264769aad8))
* **68-02:** typed Unipile errors + classifyUnipileError (Task 3) ([ebcf2f9](https://github.com/Yassinello/kebab-mcp/commit/ebcf2f9364e3402a7fb4c6d734bda1773c0ac2c5))
* **68-02:** withRetry exponential-backoff helper (Task 2) ([3c9cab6](https://github.com/Yassinello/kebab-mcp/commit/3c9cab63878b3e0db82d9ddf688aac12d14b0625))
* **68-03:** admin DELETE for URN cache eviction (D-11/D-18 escape hatch) ([81fdb50](https://github.com/Yassinello/kebab-mcp/commit/81fdb5018cd3b98783d44dc5a4d66fa3558893df))
* **68-03:** URL→URN resolver with 30-day KV cache (D-09/D-10/D-12/D-18) ([e13f5cc](https://github.com/Yassinello/kebab-mcp/commit/e13f5cc13a079ec7c93aa97934185974a4e0163e))
* **68-04:** KV-backed audit log writer + dedup checker (D-05/D-07/D-08/D-18) ([331d152](https://github.com/Yassinello/kebab-mcp/commit/331d152ac338962b83ad8d1783cbc42257e3ceb2))
* **68-05:** CRM bridge skeleton — CrmAdapter interface + TwentyAdapterSkeleton outbox writer (D-01) ([7eeac00](https://github.com/Yassinello/kebab-mcp/commit/7eeac00e0cf0ca6aaf2c83e03fab3364ed1a65b6))
* **68-06:** linkedin_get_relationship_status — D-21 envelope {degree, connection_status} ([01ccf0c](https://github.com/Yassinello/kebab-mcp/commit/01ccf0c31edd055cd6544918e35f14dba99a2fcb))
* **68-06:** linkedin_send_connection — verify-after-write + D-14 envelope (Antoine Vercken re-validation) ([03c1def](https://github.com/Yassinello/kebab-mcp/commit/03c1def03cd5620e00feb8322c8888743f76bae0))
* **68-06:** wire 2 unipile tools into manifest + bump registry toolCount + doc-counts ([a9cd234](https://github.com/Yassinello/kebab-mcp/commit/a9cd234ff36efef39b354b686e87ea7299b030e2))
* **69-01:** audit tests for phase-69 AuditResult members + identifiers SLUG_RE D-44 fix ([e66fdb8](https://github.com/Yassinello/kebab-mcp/commit/e66fdb872de3a64c3eac5aa2f63da70e9aa43192))
* **69-01:** extend unipile errors.ts (+5 classes / +3 enum / +4 classifier branches) + audit.ts AuditResult (+9 members) ([f4069ac](https://github.com/Yassinello/kebab-mcp/commit/f4069ac653ef32f0898dfeb8cc6a2c5e0c233a4b))
* **69-01:** extract resolveAccountId into shared lib/account.ts (D-20 anti-drift) ([f0d46cf](https://github.com/Yassinello/kebab-mcp/commit/f0d46cf4282c744b4481bce76895fd4cad3b9f72))
* **69-02:** unipile rate-limiter — per-account day+week KV counters, fail-closed default (D-38..D-41) ([656f564](https://github.com/Yassinello/kebab-mcp/commit/656f56407ded9e90a8335d1adb41abc1fbd1b202))
* **69-03:** linkedin_send_message — 9-step handler (D-22 degree gate + D-46 attachments + D-47 verify-poll) ([0531e35](https://github.com/Yassinello/kebab-mcp/commit/0531e357a233d6d78d66961229aab25b79d18ccd))
* **69-04:** linkedin_send_inmail — 13-step handler with balance bracketing ([f63dd8c](https://github.com/Yassinello/kebab-mcp/commit/f63dd8c323c367787dd5773c17c02383b07103b0))
* **69-05:** linkedin_list_pending — read-only paginated invitations list (UNI-10) ([adce2ab](https://github.com/Yassinello/kebab-mcp/commit/adce2abf81dd4fcb4d5c1cb6f15ce820259cb5ad))
* **69-06:** linkedin_engage super-tool — degree-routed dispatcher with dry_run preview (UNI-09) ([2371ad8](https://github.com/Yassinello/kebab-mcp/commit/2371ad874e2f9c0ab4503917acb29b4ded715d3f))
* **69-06:** retrofit linkedin_send_connection with per-account rate-limiter (D-43 + D-49) ([ffb99b1](https://github.com/Yassinello/kebab-mcp/commit/ffb99b14f8120dc1ba92c0019c4249b846bf5228))
* **69-06:** wire 4 phase-69 unipile tools into manifest + registry + docs (UNI-07..10) ([d87d19d](https://github.com/Yassinello/kebab-mcp/commit/d87d19d4694faa05562b9e90bcfacbf21870f07e))
* **70-01:** bootstrap script for 3 Unipile webhook subscriptions (UNI-12 / D-67 / D-68) ([381b7fe](https://github.com/Yassinello/kebab-mcp/commit/381b7fe2b45fa0cf74ebafac0a1c83ff211bf62d))
* **70-01:** webhook route + event dispatcher (UNI-12 ingress) ([40ca1ca](https://github.com/Yassinello/kebab-mcp/commit/40ca1ca09e6a0eab3b6a9bf20749cf4c1ee5ca7b))
* **70-01:** webhook verifier + halt-flag + account-tenant reverse index (UNI-12 Wave 1 foundation) ([3b080ea](https://github.com/Yassinello/kebab-mcp/commit/3b080ea4c48978cb09cf964f746bbaa242ca2f84))
* **70-02:** extend audit.ts (3 new enum members + reverse-lookup) + ship account_status handler ([2ee4723](https://github.com/Yassinello/kebab-mcp/commit/2ee472391d2c9a37c675162bf565f9b741bb0eb3))
* **70-02:** ship new_relation + message_received handlers + barrel registration ([e9df4f7](https://github.com/Yassinello/kebab-mcp/commit/e9df4f756be52c74ff561c8b63dff21cf3951733))
* **70-03:** retrofit Step 0 halt-check on 4 LinkedIn write tools (UNI-13 closure) ([377da01](https://github.com/Yassinello/kebab-mcp/commit/377da014f407318415ed1854d2ddbf38e05fc9a1))
* **71-01:** retrofit Step -1 kill-switch on 4 LinkedIn write tools + manifest probe (UNI-20) ([217dccb](https://github.com/Yassinello/kebab-mcp/commit/217dccba29b9f6e90794e79ca4200bd8fe2c919e))
* **71-01:** ship kill-switch helper + AuditResult/TestConnectionResult extensions (UNI-20) ([ebf72b6](https://github.com/Yassinello/kebab-mcp/commit/ebf72b6b09317a1afa1749aef4298b0ce190d2f4))
* **71-02:** ship per-account/per-tool quota route + export rate-limiter internals (UNI-21 part 1) ([87b5edb](https://github.com/Yassinello/kebab-mcp/commit/87b5edb8f078fa9e2538efde19b669b447e3d0f2))
* **71-02:** ship summary matrix + cursor-paginated audit query routes (UNI-21 part 2 + UNI-22) ([256864c](https://github.com/Yassinello/kebab-mcp/commit/256864c63768a223b517621301672ebf05ff0d1f))
* **72:** Unipile default-account selector — pin which LinkedIn/WhatsApp account is yours ([#32](https://github.com/Yassinello/kebab-mcp/issues/32)) ([fe70c16](https://github.com/Yassinello/kebab-mcp/commit/fe70c16de357215b02b4142dbba09f8089d0c5f2))
* **auth:** per-token connector scoping (v0.20) ([#48](https://github.com/Yassinello/kebab-mcp/issues/48)) ([3ddf806](https://github.com/Yassinello/kebab-mcp/commit/3ddf806da663736741585d384f4b1f25a01f8f08))
* **config-ui:** add credential forms for unipile, github, linear, airtable ([8b4b1b4](https://github.com/Yassinello/kebab-mcp/commit/8b4b1b4736272d9a2228595786d047c2af962565))
* **config-ui:** reveal bootstrap token in MCP-install panel ([40d6700](https://github.com/Yassinello/kebab-mcp/commit/40d670074eb97c99145fdea69bbdbc2303ebe880))
* **connectors:** multi-account as the primary path for Slack & Notion ([#34](https://github.com/Yassinello/kebab-mcp/issues/34)) ([868955c](https://github.com/Yassinello/kebab-mcp/commit/868955c6bc64e9de3b72f39064b4072f301f89ab))
* **custom-tools:** add per-step + total timeouts via AbortController ([93fd657](https://github.com/Yassinello/kebab-mcp/commit/93fd65731d3231703d1f6042f886a325ab582eac))
...
* **custom-tools:** bonus QoL — orphan cleanup, transport E2E test, cross-step var validation ([07c785a](https://github.com/Yassinello/kebab-mcp/commit/07c785a34ad3885e8a09ca819179362c47245030))
* **custom-tools:** composer guard-rails - format/validate, autocomplete hint, dry-run, friendly errors ([ddbbf12](https://github.com/Yassinello/kebab-mcp/commit/ddbbf12f3a74d93d00a6bb1b453436169aac5722))
...
* **custom-tools:** inline help panel + sample preview empty state (UX onboarding) ([c9e1719](https://github.com/Yassinello/kebab-mcp/commit/c9e1719aa312db48ebc46c02de23508be2c59f0a))
* **custom-tools:** persist run telemetry + Recent runs UI tab ([a7c769e](https://github.com/Yassinello/kebab-mcp/commit/a7c769e13e798b79c6e8f09f2e401329a471364c))
* **custom-tools:** rate-limit /test endpoint + cost budget at write-time ([54772df](https://github.com/Yassinello/kebab-mcp/commit/54772df599d9406870dcfb8a0230bfd08272f510))
...
* **custom-tools:** versioning + dedicated edit page + list view search/chips ([06e7f9b](https://github.com/Yassinello/kebab-mcp/commit/06e7f9b27ec02c980ad992e50ff2fc9c600a860c))
* **google:** add Google Chat support ([#37](https://github.com/Yassinello/kebab-mcp/issues/37)) ([b1e1d08](https://github.com/Yassinello/kebab-mcp/commit/b1e1d082a0c38baec0db8339605b5401651d7124))
* **google:** multi-account support (v0.19) ([#39](https://github.com/Yassinello/kebab-mcp/issues/39)) ([2f2168b](https://github.com/Yassinello/kebab-mcp/commit/2f2168bb9f834554a8478751581aa82b75c7ac42))
* **notion:** create under a page OR database + Markdown → blocks ([#35](https://github.com/Yassinello/kebab-mcp/issues/35)) ([3dea74f](https://github.com/Yassinello/kebab-mcp/commit/3dea74f537f8f58a7712b203e03c46ac28ec844b))
* **notion:** page rewriting, reliable reads, and rich blocks (v0.21) ([#52](https://github.com/Yassinello/kebab-mcp/issues/52)) ([b76be6f](https://github.com/Yassinello/kebab-mcp/commit/b76be6f8ba69a21fd197a67a7eadb9875fe188b4))
* **proxy:** make admin cookie max-age configurable via KEBAB_COOKIE_MAX_AGE_DAYS ([7823d54](https://github.com/Yassinello/kebab-mcp/commit/7823d54e96551c1c3a82d26a24d9a5c92d574e1c))
* **slack,notion:** DM tool, DB schema, typed updates, time-bounded reads ([#36](https://github.com/Yassinello/kebab-mcp/issues/36)) ([a854caf](https://github.com/Yassinello/kebab-mcp/commit/a854caf0bf751a8329d86bec88bd4338b7f7bac6))
* **unipile:** add linkedin_list_inbox + linkedin_read_messages read tools ([79301df](https://github.com/Yassinello/kebab-mcp/commit/79301df8e78f302122137ad4bbbaa2c8ede2121b))
* **unipile:** add whatsapp_list_inbox + whatsapp_read_messages read tools ([9fd62f2](https://github.com/Yassinello/kebab-mcp/commit/9fd62f2bce905e0f90204a87df8e5b5a18980b43))
* **v0.18:** multi-account support for Slack & Notion connectors ([#33](https://github.com/Yassinello/kebab-mcp/issues/33)) ([7f6c11e](https://github.com/Yassinello/kebab-mcp/commit/7f6c11e58de40183f8f89e19b8edb4780fb37421))


### Bug Fixes

* **68/client:** tolerate UNIPILE_DSN with or without https:// prefix ([115ddd3](https://github.com/Yassinello/kebab-mcp/commit/115ddd39c88e81d5d5e47630b819cfc1cf419a26))
* **apify,browser:** linkedin_post input, lnkd.in resolution, scroll_count coercion ([#56](https://github.com/Yassinello/kebab-mcp/issues/56)) ([821e1ce](https://github.com/Yassinello/kebab-mcp/commit/821e1cebc06e6eb215f70f318f0b218da090ca26))
...
* **connectors:** show Slack/Notion credential guide on disabled cards ([2f04be5](https://github.com/Yassinello/kebab-mcp/commit/2f04be53ca00f8e0456c2d97e6f8f05d216e1a43))
* **credentials:** prevent KV hydration from poisoning lambda on transient failure ([f623119](https://github.com/Yassinello/kebab-mcp/commit/f6231197527e86073b5cb1f2cba8c76a0deeced9))
...
* **deploy:** add .vercelignore to keep local .env out of CLI deploys ([51245ab](https://github.com/Yassinello/kebab-mcp/commit/51245abda20fbbb682ae7ad9e1b1e9e2770d89a2))
* **notion:** accept the markdown people actually write ([#54](https://github.com/Yassinello/kebab-mcp/issues/54)) ([e44f063](https://github.com/Yassinello/kebab-mcp/commit/e44f0631b78fa3c7c99a0cc954c10e9191723838))
* **notion:** tell users to pick "Access token", not OAuth ([0cfae22](https://github.com/Yassinello/kebab-mcp/commit/0cfae224fc55e43e5cf74e673315e5ac35eb976e))
* **slack:** clarify where the Bot User OAuth Token lives (not Basic Information) ([82c5f39](https://github.com/Yassinello/kebab-mcp/commit/82c5f39b2f7af10ea72ebdebf6b2df5453d4b439))
* tenant isolation, multi-device auth, SSRF DNS-rebind & webhook HMAC + doc accuracy ([#29](https://github.com/Yassinello/kebab-mcp/issues/29)) ([e77036d](https://github.com/Yassinello/kebab-mcp/commit/e77036d23c5e690a98c8a8a3513999b4eef1b64a))
* **unipile/review:** H-01 — engage refuses InMail without message body ([b4c52f5](https://github.com/Yassinello/kebab-mcp/commit/b4c52f580e47b6d3a7f6874c3555df91180c1195))
* **unipile/review:** I-03 — validate account_id shape on quotas route ([f80de42](https://github.com/Yassinello/kebab-mcp/commit/f80de42a0b3cbb952f2cdfef394dc21662bf51e5))
* **unipile/review:** L-01 — use String.prototype.replaceAll in sanitizeUnipileText ([457e9c8](https://github.com/Yassinello/kebab-mcp/commit/457e9c82f53557976465ab245349b87d4064a6fa))
* **unipile/review:** L-04 — trim + lowercase HMAC sig header on ingress ([ca46454](https://github.com/Yassinello/kebab-mcp/commit/ca4645425bf0fdb151d4c18e0188e0a2ec32d84b))
* **unipile/review:** L-05 — cap older_than_days at 365 on list_pending ([29be6e3](https://github.com/Yassinello/kebab-mcp/commit/29be6e34225149338d1d01b68a5cd900b4975ba9))
* **unipile/review:** M-01 + TI-04 — delete duplicated resolveAccountId in phase-68 tools ([55a7ffa](https://github.com/Yassinello/kebab-mcp/commit/55a7ffa3b24ce8a07fed6102526143bdabf34640))
* **unipile/review:** M-02 — log transient errors in pollForRelation ([0890c62](https://github.com/Yassinello/kebab-mcp/commit/0890c62d43e3be3487c6aea248a1247894d860bc))
* **unipile/review:** M-05 — initialize degree to null in send_message ([c93fa0d](https://github.com/Yassinello/kebab-mcp/commit/c93fa0dbb0f80a58a63841d190f372f4c9f56184))
* **unipile/review:** M-06 — normalize profile_url before computeParamsHash in engage ([29e045a](https://github.com/Yassinello/kebab-mcp/commit/29e045ae331ebc908d626058fbe94c2aa8ca8861))
* **unipile/review:** TI-07 — strip duplicate [CONNECTOR:unipile] prefixes from log messages ([6feeeb9](https://github.com/Yassinello/kebab-mcp/commit/6feeeb9584bf538428faa5f177c61c79b5314cef))
* **unipile:** probe accepts DSN with or without https:// prefix ([84b1cc7](https://github.com/Yassinello/kebab-mcp/commit/84b1cc7c42739433486daa81489dadd431b6ef03))
...
* **browser:** bump linkedin_feed daily rate limit from 3 to 5 ([520c50b](https://github.com/Yassinello/kebab-mcp/commit/520c50b7a612f701d98032f5df8475d81b93048e))
* **browser:** LinkedIn context connect button via Browserbase Live View ([d615098](https://github.com/Yassinello/kebab-mcp/commit/d61509852d2a80f22a0b5b48e542137142df83a7))
...
* **ci:** unblock knip on @composio/json-schema-to-zod transitive ([6c60050](https://github.com/Yassinello/kebab-mcp/commit/6c60050ff92dc0edeb8207188351f35457f34023))
